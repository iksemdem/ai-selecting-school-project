...
# Podział na zmienne cech (X) i zmienną docelową (y)
...
# Wybór modelu (w tym przypadku RandomForestClassifier)
model = RandomForestClassifier(n_estimators=100, random_state=42)
model.fit(X_train, y_train)

# uzycie SelecFromModel
sfm = SelectFromModel(model, threshold='mean')  # wybieranie cech powyzej sredniej waznosci
